...
export const reviewKey=material=>createHash('sha256').update(JSON.stringify(['weekly-research-v1',material.source_url,material.title,material.snippet])).digest('hex');
