...
{ "operating_market": "unknown", "market_quote": "", "business_form": "software", "answers": {
  "payer": {"answer":"谁付钱；没有收入证明时写潜在付费对象，不能称已有客户", "basis":"inference", "quote":""},
...
枚举字段只能填一个值，不要输出斜杠选项列表。business_form 可选 software、design、content、ecommerce、knowledge、business-service、other。operating_market 默认 unknown，market_quote 默认空字符串；仅有明确经营地区原文时才修改。
JSON 字符串中的英文双引号必须转义；引用必须逐字复制原文，不要翻译、缩写或拼接。
